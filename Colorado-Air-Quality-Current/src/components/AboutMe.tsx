...
const AboutMe: React.FC<AboutMeProps> = ({ onNavigateToInSimpleTerms }) => {
  return (
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <button 
                  ...
                  className="text-primary-600 hover:text-primary-700 dark:hover:text-primary-300 underline font-medium transition-colors duration-200"
                >
